...
import { openBookingForRoute, openBookingForSegment } from '../utils/bookingUtils';
...
export function RouteDetailsPage({ route, onBack }) {
    ...
    const {
        from, to, price, duration, departure, arrival,
        transfers, type, label, segments = [],
    } = route;
    ...
    return (
        <ScrollView showsVerticalScrollIndicator={false} style={styles.scroll}>
            ...
            <Text style={styles.pageSubtitle}>{from} → {to}</Text>
            ...
            <View style={styles.summaryCard}>
                ...
                <View style={styles.timeRow}>
                    <MaterialCommunityIcons
                        name="clock-outline" size={14}
                        color={COLORS.text} style={{ opacity: 0.45 }}
                    />
                        ...
                        return (
                            <View key={seg.id} style={styles.segCard}>
                                ...
                                <View style={styles.segHeader}>
                                    <View style={styles.iconRow}>
                                        <MaterialCommunityIcons
                                            name={segIcon} size={16} color={COLORS.secondary}
                                        />
                                ...
                                >
                                    <MaterialCommunityIcons
                                        name="open-in-new" size={13} color={COLORS.primary}
                                    />
...
const styles = StyleSheet.create({
    ...
    segRoute: { fontSize: 15, fontWeight: '600', color: COLORS.text, marginBottom: 8 },
    segMeta: {
        flexDirection: 'row',
        alignItems: 'center',
        gap: 10,
    ...
    transferLabel: { fontSize: 11, color: COLORS.text, opacity: 0.4, fontWeight: '500' },
    bookBtn: {
        flexDirection: 'row',
        alignItems: 'center',
